...
client.on("ready", () => {
  client.user.setActivity(`Angel Giveaway | a?help`);
  passport.use(
    new Strategy(
      {
...
linkss = linkA
 sahipp = sahip
  ...
  app.get("/copyright", checkAuth, (req, res) => {
  ...
  app.get("/profile", (req, res) => {
   ...
   app.get("/index2", (req, res) => {
    renderTemplate(res, req, "index2.ejs");
  });
  app.get("/main", (req, res) => {
    renderTemplate(res, req, "main.css");
  });
